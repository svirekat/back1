...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['login']) && isset($_POST['password'])) { // Авторизация
        $login = $_POST['login'];
    ...
    else if (isset($_SESSION['user_id'])) { // Редактирование данных после авторизации
        // ... (прежний код обработки данных, но теперь он внутри проверки сессии) ...
